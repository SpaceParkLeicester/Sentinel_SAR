...
path_input=/media/rose/Samsung_T51/Bouba_Ndjida/data/
path_output_VH=/media/rose/Samsung_T51/Bouba_Ndjida/Process_data/VH/
path_output_VV=/media/rose/Samsung_T51/Bouba_Ndjida/Process_data/VV/
...
for j in $(ls $path_input$S1*.zip)
	do
		...
		date
		gpt /home/rose/acquisition_traitement_auto/SNAP_process/gpt_batch_process_BNP.xml -Pinput_data=$j -Poutput_data1="$path_output_VH$m$VH_data" -Poutput_data2="$path_output_VV$m$VV_data"
		#c='expr $c + 1'
		#echo $c
		date		
	done
