...
@click.option('--start_date', type = str, default = '2023-03-01', help = 'Enter the start date of the search')
@click.option('--end_date', type = str, default = '2023-03-04', help = 'Enter the last date of the search')
@click.option('--half_side', type = int, default = 50, help = 'Enter the half side of the desired AOI')
@click.option('--location_name', type = str, defualt = 'flotta', help = 'Enter the name of the oil terminal location')
